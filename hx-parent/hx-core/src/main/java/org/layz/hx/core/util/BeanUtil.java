...
public class BeanUtil {
	...
	public static<T> T getBean(Class<T> clazz, Object source, TableClassInfo tableClassInfo) {
		return getBean(clazz, source, tableClassInfo, null);
	}
	 ...
	 * @return
	 */
	public static<T> T getBean(Class<T> clazz, Object source, TableClassInfo tableClassInfo, Map<Object, Object> cacheMap) {
